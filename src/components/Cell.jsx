    ...
    <div className=" inline-flex relative w-fit">
      <input
        ...
        onBlur={onBlur}
         onFocus={onFocus}
        onKeyDown={onKeyDown}
        className="border border-custom-blue outline-none p-2 text-custom-dark hover:shadow-[4px_4px_0px_#3139FB] focus:shadow-[4px_4px_0px_#3139FB] transition-all duration-300  ease-linear w-fit"
      />
